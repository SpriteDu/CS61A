...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    flag = False # to see if one exist in die
    sum = 0 # inital value of sumation
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    result = abs(player_score % 10 - opponent_score//10%10) *3
    if (result < 1):
        result = 1
    return result
    # END PROBLEM 2
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    # print(score)
    score_temp = boar_brawl(score, opponent_score) + score
    # print(score_temp)

    if (num_factors(score_temp) == 3 or num_factors(score_temp) ==4):
        score_temp = next_prime(score_temp)
        # print(score_temp)
